...
define('exq-admin/controllers/application', ['exports'], function (exports) {
  ...
  ApplicationController = Ember.Controller.extend({
    stats: Ember.inject.service(),
    setupStatsOnInit: Ember.on('init', function () {
      var ref;
      return (ref = this.get('stats')) != null ? ref.loadFromStats(this.model) : void 0;
    })
  });
    ...
    actions: {
      clearFailures: function clearFailures() {
        ...
        return (0, _icAjax["default"])({
          ...
          self.store.findAll('failure').forEach(function (f) {
  ...
  ApplicationRoute = Ember.Route.extend({
    ...
    actions: {
      reloadStats: function reloadStats() {
        return this.get('store').findRecord('stat', 'all').then((function (_this) {
          return function (stats) {
            var ref;
            if ((ref = _this.get('stats')) != null) {
              ref.loadFromStats(stats);
            }
            return stats.reload();
          };
        })(this));
...
define('exq-admin/services/stats', ['exports', 'ember'], function (exports, _ember) {
  var StatsService;

  StatsService = _ember['default'].Service.extend({
    processed: 0,
    failed: 0,
    busy: 0,
    enqueued: 0,
    retrying: 0,
    scheduled: 0,
    loadFromStats: function loadFromStats(stats) {
      if (!stats) {
        return;
      }
      this.set('processed', stats.get('processed') || 0);
      this.set('failed', stats.get('failed') || 0);
      this.set('enqueued', stats.get('enqueued') || 0);
      this.set('retrying', stats.get('retrying') || 0);
      return this.set('scheduled', stats.get('scheduled') || 0);
    },
    incrementStat: function incrementStat(stat, value) {
      var newValue;
      newValue = this.get(stat) + value;
      return this.set(stat, newValue);
    },
    setStat: function setStat(stat, value) {
      return this.set(stat, value);
    }
  });
...
define("exq-admin/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["content", "exq-navbar", ["loc", [null, [1, 0], [1, 14]]]], ["content", "exq-stats", ["loc", [null, [1, 37], [1, 50]]]], ["content", "outlet", ["loc", [null, [1, 50], [1, 60]]]]],
      locals: [],
      templates: []
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "retry.queue", ["loc", [null, [1, 202], [1, 217]]]], ["content", "retry.class", ["loc", [null, [1, 226], [1, 241]]]], ["content", "retry.args", ["loc", [null, [1, 250], [1, 264]]]], ["content", "retry.failed_at", ["loc", [null, [1, 273], [1, 292]]]], ["content", "retry.retry_count", ["loc", [null, [1, 301], [1, 322]]]]],
        locals: ["retry"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model", ["loc", [null, [1, 176], [1, 181]]]]], [], 0, null, ["loc", [null, [1, 168], [1, 341]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "scheduled.queue", ["loc", [null, [1, 197], [1, 216]]]], ["content", "scheduled.class", ["loc", [null, [1, 225], [1, 244]]]], ["content", "scheduled.args", ["loc", [null, [1, 253], [1, 271]]]], ["content", "scheduled.scheduled_at", ["loc", [null, [1, 280], [1, 306]]]]],
        locals: ["scheduled"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model", ["loc", [null, [1, 167], [1, 172]]]]], [], 0, null, ["loc", [null, [1, 159], [1, 325]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("exq-admin/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_VIEW_LOOKUPS":true,"name":"exq-admin","version":"0.0.0+7a7533f6"});
}
